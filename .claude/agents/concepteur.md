...
Avant tout, charge le skill `apple-design` : c'est le vocabulaire déjà en place sur la Tour
et sur OP GESTION (réponse au doigt qui se pose, ressorts plutôt que durées, chemins
symétriques, interruptibilité, matières et translucidité, typographie optique, mouvement
réduit). Ne réinvente pas ce vocabulaire, prolonge-le.
