...
/* CATALOGUE : déplacé dans data/catalogue.json (chargé par data/data.js avant ce fichier). */
...
/* REPORT_TEMPLATES : déplacé dans data/report-templates.json (chargé par data/data.js avant ce fichier). */
...
/* I18N : déplacé dans data/i18n.json (chargé par data/data.js avant ce fichier). */
